...
バグ報告・機能リクエストは [GitHub Issues](https://github.com/tjackiet/bitbank-lab-cli/issues) へお願いします。セキュリティ上の問題は公開 Issue にせず、リポジトリの [SECURITY.md](https://github.com/tjackiet/bitbank-lab-cli/blob/main/SECURITY.md) のフロー（GitHub の Private vulnerability reporting）に従って非公開で報告してください。
